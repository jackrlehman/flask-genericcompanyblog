...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is not None and user.check_password(form.password.data):
            ...
            next = request.args.get('next') #Send user to requested page
...
def account():
    ...
    return render_template('account.html.j2', profile_image=profile_image, form=form)
...
def user_posts(username):
    ...
    return render_template('user_blog_posts.html.j2',blog_posts=blog_posts,user=user)
